...
function setEmbed(){
  ...
  let height=result.offsetHeight*0.9-Number(getCSS(result,"font-size").replace("px",""))*5;
  ...
  ctx.closePath();
  ctx.fillStyle="black";
  ctx.font=getCSS(canvas,"--font-size")+" sans-serif";
  ...
  if(min<(max||nowYear)){
    ...
    let barY=height*0.225+margin/2;
